 ...
 * Use the [SuaraTerbaruFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class SuaraTerbaruFragment : Fragment() {
    lateinit var binding: FragmentSuaraTerbaruBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentSuaraTerbaruBinding.inflate(layoutInflater)
        return binding.root
    }
